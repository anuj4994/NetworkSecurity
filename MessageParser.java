...
public class MessageParser {
   ...
   static String COOKIE ="K74USE233V5RH042PZU";
   String PPCHECKSUM="";
   int HOST_PORT;
   ...
   public boolean Login() { 
      ...
      try {
	String msg1 = GetMonitorMessage();
	System.out.println("\n\t"+msg1);

	while(msg1.contains("REQUIRE")){
	String expectedInput = (msg1.substring(msg1.indexOf("REQUIRE")+9,msg1.indexOf("WAITING")-1));
System.out.println("expectedInput = "+expectedInput);	
if(expectedInput.equals("IDENT"))
Execute("IDENT");
if(expectedInput.equals("PASSWORD"))
Execute("PASSWORD");
if(expectedInput.equals("ALIVE"))
Execute("ALIVE");
if(expectedInput.equals("HOST_PORT"))
Execute("HOST_PORT");
if(expectedInput.equals("QUIT"))
Execute("QUIT");
System.out.println("Test");
msg1 = GetMonitorMessage();	
System.out.println("Response from Monitor : "+msg1);
	}
...
SendIt(inputCommand);
System.out.println("Response from Monitor: "+GetMonitorMessage());
